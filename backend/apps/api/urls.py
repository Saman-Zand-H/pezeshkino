...
router.register(prefix="city", viewset=ShahrViewset, basename="cities")
router.register(prefix="province", viewset=OstanViewset, basename="provinces")
router.register(prefix="doctor", viewset=DoctorViewset, basename="doctors")
router.register(
    prefix="doctor_office", viewset=DoctorOfficeViewset, basename="doctor_offices"
)
router.register(
    prefix="appointment", viewset=AppointmentsViewset, basename="appointments"
)
router.register(
...
urlpatterns = [
    ...
    path(
        route="doctor_offices/",
        view=views.GetDoctorOfficesView.as_view(),
