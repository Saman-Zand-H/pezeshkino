...
from doctors.models import AvailabilityTime, DoctorOffice
...
class Appointment(models.Model):
    uuid = models.UUIDField(
        default=uuid4, unique=True, auto_created=True, editable=False
    )
    ...
    office = models.ForeignKey(
        DoctorOffice, on_delete=models.CASCADE, related_name="office_appointments"
    )
    ...
    @property
    def is_paid(self):
        return self.transaction is not None and self.transaction.is_success
